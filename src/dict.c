...
const Cell sys_dict[172] = {
    ...
    (Cell)(sys_dict + 131), 0x53414204, 0x02000045,             (Cell)&code_docol,   // BASE    [139, CFA:142]
        (Cell)(sys_dict + 20),  // LIT
        (Cell)&base,          
        (Cell)(sys_dict + 7),   // EXIT

    (Cell)(sys_dict + 139), 0x52524507, 0x45444F43, 0x03000000, (Cell)&code_docol,   // ERRCODE [146, CFA:150]
        (Cell)(sys_dict + 20),  // LIT
        (Cell)&error,         
        (Cell)(sys_dict + 7),   // EXIT
    ...
    (Cell)(sys_dict + 146), 0x49555104, 0x02000054,             (Cell)&code_docol,   // QUIT    [154, CFA:157]
        (Cell)(sys_dict + 20),   // LIT
        0,                     
        (Cell)(sys_dict + 127),  // CELL
        (Cell)(sys_dict + 142),  // BASE
        (Cell)(sys_dict + 105),  // *
