...
static const Cell sys_dict[213] = {
    (Cell)NULL,             0x49584544, 0x42000054,             (Cell)&code_exit,    // EXIT    [0, CFA:3]
    (Cell)(sys_dict + 0),   0x41524246, 0x4248434E,             (Cell)&code_branch,  // BRANCH  [4, CFA:7]
    (Cell)(sys_dict + 4),   0x52423047, 0x48434E41, 0x43000000, (Cell)&code_zbranch, // 0BRANCH [8, CFA:12]
    (Cell)(sys_dict + 8),   0x54494C43, 0x42000000,             (Cell)&code_lit,     // LIT     [13, CFA:16]
    (Cell)(sys_dict + 13),  0x52524526, 0x22545354,             (Cell)&code_errtst,  // ERRTST  [17, CFA:20]
    ...
    (Cell)(sys_dict + 152), 0x434F4405, 0x02004C4F,             (Cell)&code_docol,   // DOCOL   [155, CFA:158]
        (Cell)(sys_dict + 16),  // LIT
        (Cell)&code_docol,    
        (Cell)(sys_dict + 3),   // EXIT
    ...
    (Cell)(sys_dict + 177), 0x41545305, 0x02004554,             (Cell)&code_docol,   // STATE   [184, CFA:187]
        (Cell)(sys_dict + 16),  // LIT
        (Cell)&state,         
        (Cell)(sys_dict + 3),   // EXIT

    (Cell)(sys_dict + 184), 0x49555104, 0x02000054,             (Cell)&code_docol,   // QUIT    [191, CFA:194]
        (Cell)(sys_dict + 16),   // LIT
        0,                     
        (Cell)(sys_dict + 166),  // VERSION
...
const Cell* SYS_LATEST   = sys_dict + 191;
const Cell* SYS_QUIT_CFA = sys_dict + 194;
const Cell* SYS_LIT_CFA  = sys_dict + 16;
